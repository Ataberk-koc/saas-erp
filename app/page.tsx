    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <header className="px-6 py-4 flex items-center justify-between bg-white border-b sticky top-0 z-50">
        <div className="flex items-center gap-2">
           ...
           <span className="text-xl font-bold text-slate-900 tracking-tight">NEXURA</span>
        </div>
        
        {/* 👇 DÜZELTME: Link yerine 'a' etiketi kullandık ki scroll kesin çalışsın */}
        <nav className="hidden md:flex gap-6 text-sm font-medium text-slate-600">
            <a href="#how-it-works" className="hover:text-purple-600 transition cursor-pointer">Nasıl Çalışır?</a>
            <a href="#features" className="hover:text-purple-600 transition cursor-pointer">Özellikler</a>
            <a href="#contact" className="hover:text-purple-600 transition cursor-pointer">İletişim</a>
        </nav>
        ...
        <div className="flex gap-3">
            {session ? (
                ...
                <>
                    ...
                    <Link href="/login">
                        <Button className="bg-slate-900 hover:bg-slate-800">Ücretsiz Dene</Button>
                    </Link>
                </>
            )}
        </div>
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 bg-linear-to-b from-white to-slate-100">
        ...
        <p className="text-lg text-slate-600 max-w-2xl mb-8 leading-relaxed">
            Karmaşık muhasebe programlarını unutun. Yapay zeka ile konuşarak finansal durumunuzu öğrenin,
            tek tıkla fatura kesin ve işinizi cebinizden yönetin.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4">
            <Link href={session ? "/dashboard" : "/login"}>
                <Button size="lg" className="bg-purple-600 hover:bg-purple-700 h-12 px-8 text-lg shadow-lg shadow-purple-200">
      ...
      <section id="how-it-works" className="py-20 px-6 bg-white scroll-mt-28">
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
                <h2 className="text-3xl font-bold text-slate-900 mb-4">3 Adımda Sisteminizi Kurun</h2>
                <p className="text-slate-600">Teknik bilgi gerekmez. Sadece 5 dakikanızı ayırın.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-12 relative">
                ...
                <div className="flex flex-col items-center text-center bg-white p-4">
                    ...
                    <p className="text-slate-600 text-sm">
                        Google hesabınızla saniyeler içinde giriş yapın. Kurulum veya kredi kartı gerekmez.
                    </p>
                </div>
                ...
                <div className="flex flex-col items-center text-center bg-white p-4">
                    ...
                    <p className="text-slate-600 text-sm">
                        Çalıştığınız firmaları veya kişileri sisteme kaydedin. WhatsApp numaralarını girin.
                    </p>
                </div>
                ...
                <div className="flex flex-col items-center text-center bg-white p-4">
                    ...
                    <p className="text-slate-600 text-sm">
                        Profesyonel faturalar oluşturun ve &quot;Ciro ne kadar?&quot; diye yapay zekaya sorun.
                    </p>
                </div>
            </div>
        </div>
      ...
      <section id="features" className="py-20 px-6 max-w-6xl mx-auto border-t border-slate-100 scroll-mt-28">
        <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Neden Logo Yerine Biz?</h2>
            <p className="text-slate-600">Geleneksel yazılımların hantallığını attık, modern teknolojiyi getirdik.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-50 p-8 rounded-2xl hover:bg-white hover:shadow-lg transition border border-transparent hover:border-slate-100">
                ...
                <p className="text-slate-600 text-sm">
                    Raporlarla boğuşmayın. Asistanınız verileri okusun, size özet geçsin ve uyarılarını yapsın.
                </p>
            </div>
            ...
            <div className="bg-slate-50 p-8 rounded-2xl hover:bg-white hover:shadow-lg transition border border-transparent hover:border-slate-100">
                ...
                <p className="text-slate-600 text-sm">
                    Ofise bağlı kalmayın. Dünyanın her yerinden, her cihazdan işinizi yönetme özgürlüğü.
                </p>
            </div>
            ...
            <div className="bg-slate-50 p-8 rounded-2xl hover:bg-white hover:shadow-lg transition border border-transparent hover:border-slate-100">
                ...
                <p className="text-slate-600 text-sm">
                    Eğitim gerektirmeyen, Instagram kullanmak kadar kolay ve anlaşılır modern arayüz.
                </p>
            </div>
        </div>
      </section>
<section id="pricing" className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
                <h2 className="text-3xl font-bold text-slate-900 mb-4">Her İşletmeye Uygun Paketler</h2>
                <p className="text-slate-600">Gizli ücret yok. İstediğiniz zaman iptal edin.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 items-start">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <p className="text-sm text-slate-500 mb-6">Yeni başlayanlar için ideal.</p>
                    <Link href="/login">
                        <Button variant="outline" className="w-full mb-6">Hemen Başla</Button>
                    </Link>
                    <ul className="space-y-3 text-sm text-slate-600">
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-green-500"/> Ayda 5 Fatura</li>
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-green-500"/> 10 Müşteri Kaydı</li>
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-slate-300"/> <span className="text-slate-400 line-through">AI Asistan</span></li>
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-slate-300"/> <span className="text-slate-400 line-through">WhatsApp Entegrasyonu</span></li>
                    </ul>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-purple-600 relative scale-105 transform">
                    ...
                    <p className="text-sm text-slate-500 mb-6">Büyüyen işletmeler için.</p>
                    <Link href="/login">
                        <Button className="w-full mb-6 bg-purple-600 hover:bg-purple-700">Ücretsiz Dene</Button>
                    </Link>
                    <ul className="space-y-3 text-sm text-slate-700 font-medium">
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-purple-600"/> Sınırsız Fatura</li>
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-purple-600"/> Sınırsız Müşteri</li>
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-purple-600"/> ✨ Gemini AI Analiz</li>
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-purple-600"/> WhatsApp Butonu</li>
                    </ul>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <ul className="space-y-3 text-sm text-slate-600">
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-green-500"/> Her şey sınırsız</li>
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-green-500"/> Çoklu Kullanıcı</li>
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-green-500"/> Özel Destek Hattı</li>
                        <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-green-500"/> Özel Yedekleme</li>
                    </ul>
                </div>
